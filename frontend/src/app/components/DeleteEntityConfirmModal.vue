...
const props = withDefaults(defineProps<{
    entityName: string
    entityType: 'device' | 'routine' | 'room'
    loading?: boolean
}>(), {
    loading: false,
})
        ...
        <div class="overlay" @click="onOverlayClick">
            <div class="modal">
                <div class="modal__header">
                    <h2 class="modal__title">Eliminar {{ entityType }}</h2>
                    <button
                        class="modal__close"
                        type="button"
                        :disabled="loading"
                ...
                <p class="modal__message">
                    ¿Estás seguro de querer eliminar {{ typeLabel[entityType] }} <strong>"{{ entityName }}"</strong>?
                </p>
